...
console.log(_tasks__WEBPACK_IMPORTED_MODULE_1__["default"].retrieveTasksDueToday())
...
function addEvent () {
  _tasks_js__WEBPACK_IMPORTED_MODULE_3__["default"].createTask('Go to Work', 'i need to go to work bcoz i need money', new Date(), 'Urgent', 'None')
}
...
const TaskModule = (() => {
  const createTask = (title, description, dueDate, priority, project) => {
    const a = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate, 'yyyy-MM-dd')
    const note = new Task(title, description, a, priority, project)
  ...
  const getTaskDue = (date) => {
    ...
    const result = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(today, date)

    if (result === 1) { return 'Due Today' }
    return 'In progress'
  }
  ...
  const retrieveTasksDueToday = () => {
    ...
    for (let i = 0; i < Object.keys(tasks).length; i++) {
      ...
      console.log(a)
      const b = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(a), (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date()))
      if (b !== 1) { continue }
      list[`${Object.keys(tasks)[i]}`] = `${localStorage.getItem(Object.keys(tasks)[i])}`
    }
    console.log(list)
    if (list.length < 1) { return 'You have no tasks due today!' }
    return list
  }
